...
server.setRequestHandler(types_js_1.CallToolRequestSchema, async (request) => {
    try {
        switch (request.params.name) {
            case "create_epic": {
                const { name, description, group_id } = request.params.arguments;
            ...
            case "create_story": {
                const { name, description, workflow_state_id, group_id, epic_id, story_type } = request.params.arguments;
            ...
            case "create_task": {
                const { story_id, description, complete } = request.params.arguments;
            ...
            case "get_story": {
                const { story_id } = request.params.arguments;
            ...
            case "search_stories": {
                const { query, page_size } = request.params.arguments;
